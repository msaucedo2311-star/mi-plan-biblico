const CACHE='mi-plan-biblico-v2';
const ASSETS=['./','./index.html','./styles.css','./calendar.css','./manifest.webmanifest','./icons/icon.svg','./src/app.js','./src/data.js','./src/store.js','./src/api.js','./src/native.js'];
